...
var numeros = [1, 2, 3, 4];
var timesFut = ['santos', 'bragantino'];
var timeFutBons = ['sao paulo', 'Corinthians'];

// SPREAD
var timesDeFutebol = [].concat(timesFut, timeFutBons);
...
var carroRebeca = _objectSpread(_objectSpread({}, carroMurata), {}, {
  motor: 1.8
});
console.log(carroRebeca);

// DESESTRUTURACAO
var motorDoCarroDaRebeca = carroRebeca.motor;
var motorDoCarroDoMurata = carroMurata.motor;
